...
<%--<form action="DOT" method="post">--%>
    <form action="ReportIncomeDate" method="post">
    ...
    <h1 style="color: red">${requestScope.switch_day}</h1>
</form>
...
<%--        <form action="RR" method="post">--%>
            <form action="ReportIncomeChooseDate" method="post">
...
<%--<form action="RepCbox" method="post">--%>
    <form action="ReportIncomeBox" method="post">
        <c:choose>
...
<%--</form>--%>
<form action="Back_UserP" method="post">
